...
public class OrderPembelian extends DokumenTransaksi {
    ...
    public void cetakDokumen() {
        ...
        System.out.println("Supplier: " + supplier.getNamaMitra());
    ...
    public String getDetailTransaksi() {
        return "Order Pembelian ID: " + idTransaksi + ", Total: " + String.format("%.2f", total) + ", Status: " + status + ", Supplier: " + supplier.getNamaMitra();
    }
}